...
const DeliveryPersonProfile = () => {
  const [editDpProfileOpen, setEditDpProfileOpen] = useState(false);
  return (
    <div>
      <Grid item xs={12}>
      ...
      {editDpProfileOpen && (
        <EditDpProfileModal
          modalVisible={editDpProfileOpen}
          setModalVisible={setEditDpProfileOpen}
        />
      )}
    </div>
  );
